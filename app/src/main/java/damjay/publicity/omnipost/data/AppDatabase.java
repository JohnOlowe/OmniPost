...
public abstract class AppDatabase extends RoomDatabase {
  ...
  static final Migration MIGRATION_7_8 = new Migration(7, 8) {
    ...
    public void migrate(@NonNull SupportSQLiteDatabase db) {
      db.execSQL(
        "ALTER TABLE members ADD COLUMN kind TEXT NOT NULL DEFAULT 'member'");
      db.execSQL(
        "ALTER TABLE members ADD COLUMN skipCaption INTEGER NOT NULL DEFAULT 0");
      db.execSQL(
        "ALTER TABLE tasks ADD COLUMN titleLocked INTEGER NOT NULL DEFAULT 0");
      db.execSQL(
        "ALTER TABLE tasks ADD COLUMN skipCaption INTEGER NOT NULL DEFAULT 0");
      db.execSQL(
        "ALTER TABLE post_series ADD COLUMN skipCaption INTEGER NOT NULL DEFAULT 0");
    }
  };
